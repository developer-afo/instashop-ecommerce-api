...
type UserRepositoryInterface interface {
	...
	FindUserByReferralCode(referralCode string) (models.User, error)
...
// FindUserByReferralCode implements UserRepositoryInterface.
func (u *userRepository) FindUserByReferralCode(referralCode string) (user models.User, err error) {
	err = u.database.Connection().Model(&models.User{}).Where("referral_code = ?", referralCode).First(&user).Error
